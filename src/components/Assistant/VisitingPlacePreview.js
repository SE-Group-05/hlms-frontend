    ...
    return (
        ...
        <Box border="1px" borderColor="gray.200" p={['5px', '15px', '25px']}>
            ...
            <Stack spacing={3}>
                ...
                <Box shadow="xl" p='10px' rounded="md" mb='10px' bg={colorMode === 'light' ? "teal.50" : "teal.700"}>
                    <Text fontSize="2xl" >Distance<Badge ml="1" fontSize="0.8em" colorScheme="green" variant='outline'>{data.distance} km</Badge>
                    </Text>
                </Box>
                <Box shadow="xl" p='10px' rounded="md" mb='10px' bg={colorMode === 'light' ? "teal.50" : "teal.700"} >
                ...
                <Box shadow="xl" p='10px' rounded="md" mb='10px' bg={colorMode === 'light' ? "teal.50" : "teal.700"} >
                    <Text fontSize="2xl">Time to Reach<Badge ml="1" fontSize="0.8em" colorScheme="red" variant='outline'>{data.timeToReach} min</Badge>
                    </Text>
                </Box>
            </Stack>
        </Box>
